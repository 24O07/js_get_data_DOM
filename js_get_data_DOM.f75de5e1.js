...
document.querySelector('span.average-population').textContent = Math.round(average).toLocaleString();
document.querySelector('span.total-population').textContent = total.toLocaleString();
